...
void handleRoot() {
  String page = "<form action='/update' method='POST' style='max-width: 600px; margin: 0 auto; background-color: #fff; padding: 20px; border-radius: 10px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);'>";
  ...
  page += "<script>function updateValues() {";
  page += "  fetch('/values')";
  ...
  page += "}</script></head><body onload='updateValues()' style='font-family: Arial, sans-serif; margin: 0; padding: 20px; background-color: #f4f4f4;'>";
  ...
  page += "Latitude: <input type='text' name='latitude' value='" + String(ORIGIN_LATITUDE, 8) + "' style='width: calc(100% - 20px); padding: 10px; margin-bottom: 10px; border: 1px solid #ccc; border-radius: 5px;'><br>";
  page += "Longitude: <input type='text' name='longitude' value='" + String(ORIGIN_LONGITUDE, 8) + "' style='width: calc(100% - 20px); padding: 10px; margin-bottom: 10px; border: 1px solid #ccc; border-radius: 5px;'><br>";
  page += "Rotation: <input type='text' name='rotation' value='" + String(rot, 2) + "' style='width: calc(100% - 20px); padding: 10px; margin-bottom: 10px; border: 1px solid #ccc; border-radius: 5px;'><br>";
  // Input fields for each anchor's coordinates
  for (int i = 0; i < N_ANCHORS; i++) {
    page += "<h4 style='color: #333;'>Anchor " + String(i+1) + "</h4>";
    page += "x: <input type='text' name='anchor_x_" + String(i) + "' value='" + String(anchor_matrix[i][0]) + "' style='width: calc(100% - 20px); padding: 10px; margin-bottom: 10px; border: 1px solid #ccc; border-radius: 5px;'><br>";
    page += "y: <input type='text' name='anchor_y_" + String(i) + "' value='" + String(anchor_matrix[i][1]) + "' style='width: calc(100% - 20px); padding: 10px; margin-bottom: 10px; border: 1px solid #ccc; border-radius: 5px;'><br>";
    page += "z: <input type='text' name='anchor_z_" + String(i) + "' value='" + String(anchor_matrix[i][2]) + "' style='width: calc(100% - 20px); padding: 10px; margin-bottom: 10px; border: 1px solid #ccc; border-radius: 5px;'><br>";
  }
